(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitParentheses = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        tag = token[0];
        if (tag === 'CLASS' || tag === 'PACKAGE' || tag === 'IF') noCall = true;
        ...
        this.detectEnd(i + 1, function(token, i) {
          ...
          return !token.generated && this.tag(i - 1) !== ',' && (__indexOf.call(IMPLICIT_END, tag) >= 0 || (tag === 'INDENT' && !seenControl)) && (tag !== 'INDENT' || (this.tag(i - 2) !== 'CLASS' && this.tag(i - 2) !== 'PACKAGE' && (_ref4 = this.tag(i - 1), __indexOf.call(IMPLICIT_BLOCK, _ref4) < 0) && !((post = this.tokens[i + 1]) && post.generated && post[0] === '{')));
        }, action);
  ...
  IMPLICIT_CALL = ['IDENTIFIER', 'NUMBER', 'STRING', 'JS', 'REGEX', 'NEW', 'PARAM_START', 'CLASS', 'PACKAGE', 'IF', 'TRY', 'SWITCH', 'THIS', 'BOOL', 'UNARY', 'SUPER', '@', '->', '=>', '[', '(', '{', '--', '++'];
